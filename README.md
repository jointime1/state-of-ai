...
*Актуально на 10 апреля 2026. Всё проверено по официальной документации
...
**Для enterprise:** `managed-settings.d/` — drop-in директория для фрагментов политик рядом с `managed-settings.json`. Позволяет разным командам добавлять свои правила независимо.
...
**Важно:** в v2.1.97–v2.1.98 исправлены критические уязвимости Bash tool — обход permissions через backslash-escaping, compound commands, env-var префиксы и network redirects. Обновляйтесь.
